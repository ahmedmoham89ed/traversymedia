...
const PageSignIn = () => {
  return (
    <motion.div  initial={{opacity:0,y:50,scale:0.9}} whileInView={{opacity:1,y:0,scale:1}} transition={{duration:.2,delay:.3}} viewport={{once:false}} className="relative z-0 sm:h-[190vh] " style={{backgroundImage:`url(${back})`,width:"100%",height:"110vh",backgroundSize:"cover",backgroundPosition:"center"}}>
    <div className=" absolute z-10 inset-0 bg-black opacity-60"></div>
    <motion.div  initial={{opacity:0,y:50,scale:0.9}} whileInView={{opacity:1,y:0,scale:1}} transition={{duration:.2,delay:.4}} viewport={{once:false}} className="text-white mt-24 text-xl sm:pt-14 absolute z-30 inset-0 font-[pregular] flex flex-col items-center justify-center space-y-8">
        <motion.h1  initial={{opacity:0,y:50,scale:0.9}} whileInView={{opacity:1,y:0,scale:1}} transition={{duration:.2,delay:.5}} viewport={{once:false}} className="text-4xl font-[pbold] lg:text-5xl">Sign Up</motion.h1>
        <motion.div  initial={{opacity:0,y:50,scale:0.9}} whileInView={{opacity:1,y:0,scale:1}} transition={{duration:.2,delay:.6}} viewport={{once:false}} className="xl:w-[30vw] sm:w-[55vw] space-y-8 ">
            ...
            <motion.h1  initial={{opacity:0,y:50,scale:0.9}} whileInView={{opacity:1,y:0,scale:1}} transition={{duration:.2,delay:1.1}} viewport={{once:false}} className="text-center pt-3 cursor-pointer text-md">Forgot Password <Link to={"/LogIn"} className="text-blue-500">LogIn</Link> </motion.h1>
        </motion.div>
    </motion.div>
